    ...
    public function save($data) {
        ...
        if (isset($data_array['data']["objectId"])) { //update
            return BackendlessCollection::prepareSingleItem(
                            RequestBuilder::doRequest('data', $data_array['table'] . '/' . $data_array['data']['objectId'], $data_array['data'], 'PUT'), $data_array["type"]
            );
        } else {

            return BackendlessCollection::prepareSingleItem(
                            RequestBuilder::doRequest('data', $data_array['table'], $data_array['data']), $data_array["type"]
            );
        }
    }

        ...
        <div class="container">
            <nav class="navbar navbar-default">
                <ul class="nav nav-pills">
                    ...
                    <li role="presentation" class="active"><a href="#">Review New QA</a></li>
            ...
            <div class="panel panel-default " style="margin-top: 20px; background-color: #527a7a; ">
                ...
                <div class="panel-body" style="text-align: center;">
                    <a class="btn btn-primary" href="answerNewQA.php?q=<?php echo $id;?>">Add answer</a>
                    <a class="btn btn-danger" href="deleteNewQA.php?q=<?php echo $id;?>">Delete</a>
                </div>
            </div>
        </div>
    </body>
